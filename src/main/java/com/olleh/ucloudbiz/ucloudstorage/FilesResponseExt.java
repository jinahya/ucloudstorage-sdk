...
public class FilesResponseExt extends FilesResponse {
    ...
    */    
    ...
    /**
    * <p>
    * TempURL을 위한 Account Key값을 조회한다.
    * </p>
    *
    * @return X-Account-Temp-URL-Key 헤더의 값, 헤더가 없을 경우 null
    *
    */    
    public String getTempKey() {
		Header tempKey = getResponseHeader(FilesConstantsExt.X_ACCOUNT_TEMPURL_KEY); 
		if(tempKey != null) {
			return tempKey.getValue();
		}   
		return null;
    }   
}
